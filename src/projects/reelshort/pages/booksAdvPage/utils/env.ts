...
import { safeDecodeURIComponent } from '@/projects/reelshort/utils/urils'
...
/** 简约解密 */
function simpleDecrypt(encrypted: string) {
...
export const getDomainConfig = () => {
  const { mediaType = 'fb', px = '' }: { mediaType: 'fb' | 'tt'; px: string } =
    getLocationVars()
  /** 解码pixel */
  const pixel = px
