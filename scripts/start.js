function runStart() {
  ...
  checkBrowsers(paths.appPath, isInteractive)
    ...
    .then((port) => {
      ...
      // Load proxy config
      if (!require('../config/proxy')[paths.PROJECT_NAME][process.env.REACT_APP_ENV]) return console.log('未找到项目设置的代理域名，请到/config/proxy.js文件下添加')
      const proxySetting = require('../config/proxy')[paths.PROJECT_NAME][process.env.REACT_APP_ENV].target
...
// 命令行交互获得项目信息
const { promptStart } = require('./prompt')
  ; (async function () {
    await promptStart()
    runStart()
  })()
